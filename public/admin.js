...
// FUNÇÃO DE FORMATAÇÃO DO TELEFONE (ATUALIZADA)
function formatPhone(value) {
  if (!value) return '';
  // Remove todos os caracteres não numéricos e limita a 11 dígitos
  const digits = value.replace(/\D/g, '').slice(0, 11);

  // Aplica a máscara (XX) 9 XXXX-XXXX progressivamente
  if (digits.length > 7) {
...
    // APLICA A FORMATAÇÃO AO EXIBIR O TELEFONE NA TABELA
    row.querySelector('[data-field="phone"]').textContent = formatPhone(lead.phone);
    row
